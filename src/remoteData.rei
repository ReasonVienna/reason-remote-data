...
let map2:
  (('a, 'b) => 'c, remoteData('e, 'a), remoteData('e, 'b)) =>
  remoteData('e, 'c);
...
let andThen:
  ('a => remoteData('e, 'b), remoteData('e, 'a)) => remoteData('e, 'b);
...
let append:
  (remoteData('e, 'a), remoteData('e, 'b)) => remoteData('e, ('a, 'b));

let andMap:
  (remoteData('e, 'a), remoteData('e, ('a => 'b))) => remoteData('e, 'b);
